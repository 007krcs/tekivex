...
const loaders: Record<string, CategoryLoader> = {
  ...
  'ai-ml-advanced': () => import('./data/ai-ml-advanced'),
...
export const CATEGORY_META: CategoryMeta[] = [
  ...
  { id: 'ai-ml-advanced', title: 'Transformers, LLMs & Optimization', icon: 'zap', color: '#f59e0b', description: 'Modern AI: Transformers, BERT, GPT, fine-tuning, training optimization, and production deployment strategies.', topicCount: 8 },
